    ...
    b.fn.fullpage = function (c) {
        function k(a) {
            if (c.autoScrolling) {
                ...
                var f;
                f = b(".section.active");
                if (!l)if (f = f.find(".slides").length ? f.find(".slide.active").find(".scrollable") : f.find(".scrollable"), 0 > a)if (0 < f.length)if (u("bottom", f))b.fn.fullpage.moveSlideDown(); else return!0; else b.fn.fullpage.moveSlideDown(); else if (0 < f.length)if (u("top", f))b.fn.fullpage.moveSlideUp(); else return!0; else b.fn.fullpage.moveSlideUp();
                return!1
            }
        }

        function E() {
            document.addEventListener ? (document.addEventListener("mousewheel", k, !1), document.addEventListener("DOMMouseScroll", k, !1)) : document.attachEvent("onmousewheel", k)
        }

        function n(a, f) {
            var d = {}, e;
            e = a.position();
            var h = null !== e ? e.top : null, m = F(a), r = a.data("anchor"), p = a.index(".section"), g = b(".section.active").index(".section") + 1;
            a.addClass("active").siblings().removeClass("active");
            l = !0;
            b.isFunction(f) || (location.hash = "undefined" !== typeof r ? r : "");
            c.autoScrolling ? (d.top = -h, e = "#superContainer") : (d.scrollTop =
                h, e = "html, body");
            c.css3 && c.autoScrolling ? (b.isFunction(c.onLeave) && c.onLeave.call(this, g, m), z("translate3d(0px, -" + h + "px, 0px)", !0), setTimeout(function () {
                b.isFunction(c.afterLoad) && c.afterLoad.call(this, r, p + 1);
                setTimeout(function () {
                    l = !1;
                    b.isFunction(f) && f.call(this)
                }, G)
            }, c.scrollingSpeed)) : (b.isFunction(c.onLeave) && c.onLeave.call(this, g, m), b(e).animate(d, c.scrollingSpeed, c.easing, function () {
                b.isFunction(c.afterLoad) && c.afterLoad.call(this, r, p + 1);
                setTimeout(function () {
                        l = !1;
                        b.isFunction(f) && f.call(this)
            ...
            v = r;
            c.autoScrolling && (H(r), I(r, p))
        }

        function s(a, f) {
            var d = f.position(), e = a.find(".slidesContainer").parent(), h = f.index(), m = a.closest(".section"), g = m.index(".section"), p = m.data("anchor"), l = m.find(".fullPage-slidesNav"), k = f.data("anchor");
            if (c.onSlideLeave) {
                var n = m.find(".slide.active").index(), q;
                q = n > h ? "left" : "right";
                b.isFunction(c.onSlideLeave) && c.onSlideLeave.call(this, p, g + 1, n, q)
            }
            f.addClass("active").siblings().removeClass("active");
            "undefined" === typeof k && (k = h);
            m.hasClass("active") && (c.loopHorizontal ||
                (m.find(".controlArrow.prev").toggle(0 != h), m.find(".controlArrow.next").toggle(!f.is(":last-child"))), location.hash = h ? ("undefined" !== typeof p ? p : "") + "/" + k : location.hash.split("/")[0]);
            c.css3 ? (d = "translate3d(-" + d.left + "px, 0px, 0px)", a.find(".slidesContainer").addClass("easing").css({"-webkit-transform": d, "-moz-transform": d, "-ms-transform": d, transform: d}), setTimeout(function () {
                b.isFunction(c.afterSlideLoad) && c.afterSlideLoad.call(this, p, g + 1, k, h);
                t = !1
            }, c.scrollingSpeed)) : e.animate({scrollLeft: d.left},
                c.scrollingSpeed, function () {
                    b.isFunction(c.afterSlideLoad) && c.afterSlideLoad.call(this, p, g + 1, k, h);
                    t = !1
                });
            l.find(".active").removeClass("active");
            l.find("li").eq(h).find("a").addClass("active")
        }
        ...
        function J() {
            ...
            b(".section").each(function () {
                ...
                a.length && s(a, a.find(".slide.active"))
            });
        ...
        function M(a, b) {
            if ("undefined" != typeof b) {
                var c = a.find(".slides"), e =
                    c.find('[data-anchor="' + b + '"]');
        ...
        function R() {
            var a = document.createElement("p"), b, c = {webkitTransform: "-webkit-transform", OTransform: "-o-transform",
        ...
        c = b.extend({verticalCentered: !0, resize: !0, slidesColor: [], anchors: [], scrollingSpeed: 400, easing: "easeInQuart", menu: !1, navigation: !1, navigationPosition: "right", navigationColor: "#000", navigationTooltips: [],
            slidesNavigation: !1, slidesNavPosition: "bottom", controlArrowColor: "#fff", loopBottom: !1, loopTop: !1, loopHorizontal: !0, autoScrolling: !0, scrollOverflow: !1, css3: !1, paddingTop: 0, paddingBottom: 0, fixedElements: null, normalScrollElements: null, afterLoad: null, onLeave: null, afterRender: null, afterSlideLoad: null, onSlideLeave: null}, c);
        var G = 700;
        b.fn.fullpage.setAutoScrolling = function (a) {
            c.autoScrolling = a;
            a = b(".section.active");
            c.autoScrolling ? (b("html, body").css({overflow: "hidden", height: "100%"}), a.length && (c.css3 ?
                (a = "translate3d(0px, -" + a.position().top + "px, 0px)", z(a, !1)) : b("#superContainer").css("top", "-" + a.position().top + "px"))) : (b("html, body").css({overflow: "auto", height: "auto"}), c.css3 ? z("translate3d(0px, 0px, 0px)", !1) : b("#superContainer").css("top", "0px"), b("html, body").scrollTop(a.position().top))
        };
        var t = !1, A = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|Windows Phone)/), g = b(window).height(), l = !1, v;
        E();
        c.css3 && (c.css3 = R());
        ...
        if (c.navigation) {
            ...
            q.css("color", c.navigationColor);
            q.addClass(c.navigationPosition)
        }
        b(".section").each(function (a) {
            var f = b(this).find(".slide"), d = f.length;
            ...
            if (c.navigation) {
                var e =
                    "";
                c.anchors.length && (e = c.anchors[a]);
                a = c.navigationTooltips[a];
                "undefined" === typeof a && (a = "");
                q.find("ul").append('<li data-tooltip="' + a + '"><a href="#' + e + '"><span></span></a></li>')
            }
            if (0 < d) {
                var e = 100 * d, h = 100 / d;
                f.wrapAll('<div class="slidesContainer" />');
                f.parent().wrap('<div class="slides" />');
                b(this).find(".slidesContainer").css("width", e + "%");
                b(this).find(".slides").after('<div class="controlArrow prev"></div><div class="controlArrow next"></div>');
                b(this).find(".controlArrow.next").css("border-color",
                    "transparent transparent transparent " + c.controlArrowColor);
                ...
                c.slidesNavigation && Q(b(this), d);
                f.each(function (a) {
                    a || b(this).addClass("active");
                    b(this).css("width", h + "%");
                    c.verticalCentered && K(b(this))
                })
                ...
                c.navigation && (q.css("margin-top", "-" + q.height() / 2 + "px"), q.find("li").first().find("a").addClass("active"));
        ...
        b(window).scroll(function (a) {
            if (!c.autoScrolling) {
                ...
                if (!a.hasClass("active")) {
                    ...
                    b.isFunction(c.afterLoad) && c.afterLoad.call(this, e, a.index(".section") + 1);
                    H(e);
                    I(e, 0);
                    c.anchors.length && !l &&
                    (v = e, location.hash = e);
        ...
        b(document).on("touchmove", function (a) {
            if (c.autoScrolling && A && (a.preventDefault(), a = a.originalEvent, !l))if (D = a.touches[0].pageY, y = a.touches[0].pageX, b(".section.active").find(".slides").length && Math.abs(x - y) > Math.abs(C - D))x > y ? b(".section.active").find(".controlArrow.next").trigger("click") : x < y && b(".section.active").find(".controlArrow.prev").trigger("click"); else if (a = b(".section.active").find(".scrollable"),
                C > D)if (0 < a.length)if (u("bottom", a))b.fn.fullpage.moveSlideDown(); else return!0; else b.fn.fullpage.moveSlideDown(); else if (0 < a.length)if (u("top", a))b.fn.fullpage.moveSlideUp(); else return!0; else b.fn.fullpage.moveSlideUp()
        });
        b(document).on("touchstart", function (a) {
            c.autoScrolling && A && (a = a.originalEvent, C = a.touches[0].pageY, x = a.touches[0].pageX)
        });
        b.fn.fullpage.moveSlideUp = function () {
            var a = b(".section.active").prev(".section");
            c.loopTop && !a.length && (a = b(".section").last());
            (0 < a.length || !a.length && c.loopTop) &&
            n(a)
        };
        b.fn.fullpage.moveSlideDown = function () {
            var a = b(".section.active").next(".section");
            c.loopBottom && !a.length && (a = b(".section").first());
            (0 < a.length || !a.length && c.loopBottom) && n(a)
        };
        b.fn.fullpage.moveToSlide = function (a) {
            var c = "", c = isNaN(a) ? b('[data-anchor="' + a + '"]') : b(".section").eq(a - 1);
            0 < c.length && n(c)
        };
        b(window).on("hashchange", function () {
            if (!B) {
                var a = window.location.hash.replace("#", "").split("/"), b = a[0], a = a[1];
                (b && b !== v || "undefined" != typeof a && !t) && L(b, a)
            }
        });
        ...
        c.normalScrollElements && (b(document).on("mouseover", c.normalScrollElements, function () {
            document.addEventListener ? (document.removeEventListener("mousewheel", k, !1), document.removeEventListener("DOMMouseScroll", k, !1)) : document.detachEvent("onmousewheel", k)
        ...
        b(".section").on("click", ".controlArrow", function () {
            if (!t) {
                ...
                var a = b(this).closest(".section").find(".slides"),
                    c = a.find(".slide.active"), d = null, d = b(this).hasClass("prev") ? c.prev(".slide") : c.next(".slide");
